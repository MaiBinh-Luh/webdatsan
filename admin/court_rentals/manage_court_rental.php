...
<div class="mx-0 py-5 px-3 mx-ns-4 bg-gradient-primary">
	<h3><b><?= isset($id) ? "Update Court Rental Details" : "Đặt lịch sân" ?></b></h3>
</div>
	...
	<div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
						...
						<form action="" id="court_rental-form">
							...
							<div class="row">
								<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
									<label for="client_name" class="control-label">Tên khách hàng</label>
							...
							<div class="row">
								<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
									<label for="court_id" class="control-label">Chọn sân</label>
								...
								<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
									<label for="court_price" class="control-label">Tỷ giá theo giờ</label>
							...
							<div class="row">
								<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
									<label for="datetime_start" class="control-label">Từ Ngày</label>
								...
								<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
									<label for="hours" class="control-label">Giờ</label>
								...
								<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
									<label for="datetime_end" class="control-label">Đến Ngày</label>
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<fieldset>
										<legend>Thêm Sân</legend>
										<div class="row align-items-end mb-2">
											<div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
												<label for="product" class="control-label">Thêm sân lẻ nếu cần</label>
										...
										<table class="table table-bordered" id="product-list">
											...
											<thead>
												<tr class="bg-gradient-primary">
													...
													<th class="px-2 py-1 text-center">SỐ LƯỢNG</th>
													<th class="px-2 py-1 text-center">Tên</th>
													<th class="px-2 py-1 text-center">Giá</th>
													<th class="px-2 py-1 text-center">Tổng cộng</th>
												</tr>
											</thead>
											<tbody>
												<?php 
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<fieldset>
										...
										<div class="row align-items-end mb-2">
											<div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
												<label for="service" class="control-label">Thêm dịch vụ nếu cần</label>
			...
			<div class="card-footer py-1 text-center">
				...
				<!-- Conditionally Show the Cancel Button for type 1 users -->

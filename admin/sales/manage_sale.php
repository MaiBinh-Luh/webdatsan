...
<div class="mx-0 py-5 px-3 mx-ns-4 bg-gradient-primary">
	<h3><b><?= isset($id) ? "Update Sales Details" : "Đặt Sân" ?></b></h3>
</div>
	...
	<div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
			<div class="card-body">
				<div class="container-fluid">
					<form action="" id="sales-form">
						...
						<fieldset>
							<legend>Chọn Sân</legend>
							<div class="row align-items-end mb-2">
								<div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
									<label for="product" class="control-label">Sân đang hoạt động chưa đặt</label>
								...
								<div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<button class="btn btn-primary bg-gradient-primary btn-sm rounded-0" type="button" id="add_product"><i class="fa fa-plus"></i> Đặt Sân Này</button>
								</div>
							</div>
							<table class="table table-bordered" id="product-list">
								...
								<thead>
									<tr class="bg-gradient-primary">
										...
										<th class="px-2 py-1 text-center">Sân</th>
								...
								<tfoot>
									<tr class="bg-gradient-secondary">
										<th class="p-1 text-center align-middle" colspan="4">Tổng Đơn Hàng</th>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-primary btn-sm bg-gradient-primary rounded-0" form="sales-form"><i class="fa fa-save"></i> Đặt sân</button>
...
<script>
	...
	$(document).ready(function(){
		$('#product').select2({
			placeholder:"Vui lòng chọn sân để đặt",
			width:"100%",
